...
console.log(library.calcPriceOfBook('Book', 1995));
console.log(library.calcPriceOfBook('Book', 1960))

console.log(library.calcPriceOfBook('Book', 1979))

// console.log(library.calcPriceOfBook( 152, 1960))

// console.log(library.calcPriceOfBook('Book', 'Book'))

console.log(library.findBook(["Troy", "Life Style", "Torronto"], 'Troy'))

console.log(library.findBook(["Troy", "Life Style", "Torronto"], 'BookTwo'))

console.log(library.findBook([], 'Troy'))

console.log()

library.calcPriceOfBook('Book', 1995)

console.log(library.arrangeTheBooks(5))
